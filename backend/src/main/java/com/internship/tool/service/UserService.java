...
public class UserService {
    ...
    public List<UserDTO> searchUsersJPQL(String name) {
        ...
        logger.info(
                "Searching users using JPQL for name: {}",
                name
        );

        return userRepository.searchUsersJPQL(name)
                .stream()
                .map(user -> new UserDTO(
                        user.getName(),
                        user.getEmail()
    ...
    public List<UserDTO> searchUsersNative(String name) {

        logger.info(
                "Searching users using Native SQL for name: {}",
                name
        );

        return userRepository.searchUsersNative(name)
                .stream()
                .map(user -> new UserDTO(
                        user.getName(),
                        user.getEmail()
